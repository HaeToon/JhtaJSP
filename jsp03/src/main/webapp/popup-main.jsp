...
//    }
    String cookieValue ="on";
    cookieValue = CookieManager.readCookie(request,"oneDayCookie");
    //쿠키값이 설정되면 off
...
<script>
    ...
    $("#popup .btn-close").on("click",function() {
        ...
        // console.log($("#today-check").val()); value로 판단하면 안됨. one만 리턴함.
        // 데이터 주고받는거 ? , form , ajax
        // location.href="popup-make.jsp?today=one"; //page를 바꾸는것
        if (isChecked) {
            $.ajax({
                url: "popup-make.jsp",
                method: "GET",
